...
const Certified = () => {
  return (
    <div className="mt-28 flex justify-center items-center">
      <p className="w-[512px] h-[348px] text-[#000000] text-3xl font-medium text-center mb-10">
        We seek to empower communities of creators, customers, and partners by
        crafting products of utmost quality while mitigating environmental
        footprints along the entire value chain in which we operate.
      </p>
      <div className="relative w-[400px] h-[400px] flex justify-center items-center">
        {/* Center Image */}
        <img src={certified} alt="Certified" className="absolute z-10" />

        {/* Surrounding Images */}
        <img src={sedex} alt="Sedex" className="absolute top-0 left-1/2 transform -translate-x-1/2" />
        ...
        <img src={AFA} alt="AFA" className="absolute right-0 top-1/2 transform -translate-y-1/2" />
        <img src={WRAP} alt="WRAP" className="absolute right-4 top-72 transform -translate-y-1/2" />
        <img src={confidence} alt="Confidence" className="absolute top-[70%] right-[25%]" />
        <img src={swedenTextile} alt="Confidence" className="absolute top-[70%] right-[55%]" />
        <img src={amfori} alt="Amfori" className="absolute bottom-[25%] left-[8%]" />
        <img src={rso} alt="RSO" className="absolute bottom-[35%] left-[8%]" />
        <img src={bci} alt="RSO" className="absolute bottom-[50%] left-[8%]" />
        <img src={global} alt="RSO" className="absolute bottom-[70%] left-[8%]" />
      </div>
    </div>
  );
};
