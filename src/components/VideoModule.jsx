...
const VideoModule = () => {
  ...
  return (
    <>
      {/* MOBILE DESIGN - Will show on screens smaller than md breakpoint */}
      <div className="block md:hidden w-full max-w-sm mx-auto rounded-lg overflow-hidden shadow-lg">
        {/* Video thumbnail section */}
        <div className="relative w-full aspect-video bg-gray-100">
          {isPlaying ? (
            <iframe
              src="https://www.youtube.com/embed/gpUDSPPhf_M?autoplay=1&mute=0&controls=1&showinfo=0&rel=0&playsinline=1"
              title="YouTube video player"
              allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
              allowFullScreen
            ...
            <>
              {/* Video thumbnail with poster image */}
              <div 
                className="w-full h-full bg-black bg-opacity-40 flex items-center justify-center cursor-pointer"
                style={{
                  backgroundImage: "url('https://img.youtube.com/vi/gpUDSPPhf_M/maxresdefault.jpg')",
                  backgroundSize: "cover",
                  backgroundPosition: "center"
                }}
                onClick={handlePlayVideo}
              >
                {/* Play button - centered white circle with play icon */}
        ...
        {/* Text content section with green background - matches the image */}
        <div className="bg-[#0B714C] p-6 text-white">
      ...
      >
        {/* Main container with fixed dimensions */}
        <div className="relative rounded-2xl max-w-[1236px] mx-20 h-full overflow-hidden">
