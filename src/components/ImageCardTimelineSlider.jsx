...
const ImageCardTimelineSlider = () => {
  ...
  return (
    <div className="bg-[#0B714C] relative w-full overflow-hidden md:p-8 md:px-20">
      <h2 className="text-white text-3xl font-bold text-center pt-8 pb-12 md:mb-8">Our Journey</h2>
        ...
        <div className="w-full flex items-center">
          {timelineData.map((item, index) => (
            <React.Fragment key={item.id}>
              ...
              >
                {/* Period label */}
                <div className="text-white text-base font-medium mb-4">{item.period}</div>
                ...
                <div className="flex items-center justify-center relative">
                  ...
                  >
                    <div
                      className={`w-5 h-5 rounded-full ${index <= currentSlide ? "bg-white" : "bg-[#859E95]"}`}
                    ></div>
                  </div>
                </div>
              </div>
      ...
      <div className="md:hidden flex flex-col items-center mb-8">
        {/* Period label */}
        <div className="text-white text-2xl font-medium mb-4">{timelineData[currentSlide].period}</div>

        {/* Timeline node and line */}
        <div className="relative flex items-center justify-center w-full">
          <div className="w-12 h-12 rounded-full flex items-center justify-center bg-[#B2D4C9]">
            <div className="w-5 h-5 rounded-full bg-white"></div>
          </div>
          <div className="h-[3px] bg-white absolute left-[calc(50%+24px)] right-0"></div>
        </div>
      </div>
      ...
      <div className="hidden md:flex mb-8 justify-center pt-14">
        ...
        >
          <div>
            <h2 className="text-2xl font-bold text-black mb-4">{timelineData[currentSlide].title}</h2>
            <p className="text-black text-lg font-normal">{timelineData[currentSlide].description}</p>
          </div>
        </motion.div>
      </div>
      ...
      <div
        className="md:hidden w-full px-0"
        ref={sliderRef}
      ...
      >
        ...
        >
          ...
          <div className="w-full h-[200px] mb-4">
            <img
              src={timelineData[currentSlide].image || "/placeholder.svg"}
              alt={timelineData[currentSlide].title}
          ...
          {/* Text Card */}
          <div className="bg-white rounded-t-lg mx-4 p-6">
            <h2 className="text-[#0B714C] text-xl font-bold mb-2">{timelineData[currentSlide].title}</h2>
            <p className="text-black text-sm">{timelineData[currentSlide].description}</p>
          </div>
        </motion.div>
      </div>
